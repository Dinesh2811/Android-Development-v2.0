package com.dinesh.android.kotlin.app.user_interface.notification
...
//        val button2PendingIntent = PendingIntent.getBroadcast(context, 0, button2Intent, PendingIntent.FLAG_IMMUTABLE)
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setLargeIcon(BitmapFactory.decodeResource(context.resources, R.drawable.ic_baseline_close_24))
            .setContentTitle("Notification Title")
            .setContentText("Notification Message")
            .setPriority(NotificationCompat.PRIORITY_MAX)
            .setContentIntent(pendingIntent)
            .addAction(R.drawable.ic_baseline_arrow_back_24, "Button 1", button1PendingIntent)
//            .addAction(R.drawable.ic_baseline_menu_24, "Button 2", button2PendingIntent)
            .setAutoCancel(true)
