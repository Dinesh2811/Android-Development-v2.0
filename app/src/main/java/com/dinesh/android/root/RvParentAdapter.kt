    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            val itemClickListener = View.OnClickListener {
                listener.onParentItemClick(it, adapterPosition)
                val isExpandable: Boolean = rvParentModelList[adapterPosition].isExpandable
                childRecyclerView.visibility = if (!isExpandable) View.VISIBLE else View.GONE
                rvParentModelList[adapterPosition].isExpandable = !rvParentModelList[adapterPosition].isExpandable
            }
